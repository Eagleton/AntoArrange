...
let counter = 0;
function createData(roomId, course,room,time) {
    counter += 1;
    return { id: counter, course,room,time};
}

const columnData = [
    { id: 'id', numeric: true},
    { id: 'teacher', numeric: false, disablePadding: true, label: '任课教师' },
...
export default withStyles(styles)(ModifyTable);