...
class ClassroomModifyTableHead extends React.Component {
...
ClassroomModifyTableHead.propTypes = {
...
class ClassroomModifyTable extends React.Component {
    ...
    fetchCourses() {
        fetch(`../../Data/RoomResources.json`)
            .then(response => response.json())
            .then(data=>this.setState({data:data.classrooms}))
        ...
        return (
            <div className={classes.root}>
                ...
                <div style={{paddingTop: 20, textAlign:"end"}}>
                    ...
                    <Button variant="outlined" color="primary" style={{marginLeft:50}}>
                        删除
                    </Button>
                    <Button variant="outlined" color="primary" style={{marginLeft:50}}>
                        提交
...
ClassroomModifyTable.propTypes = {
    classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(ClassroomModifyTable);