...
const columnData = [
    ...
    { id: 'courseTime', numeric: true, disablePadding: false, label: '课时' },
    { id: 'campus', numeric: false, disablePadding: false, label: '校区' },
...
class Arranging extends React.Component {
    ...
    fetchCourses() {
        fetch(`../../Data/CourseResources.json`)
    ...
    render() {
        ...
        return (
            <Paper className={classes.root}>
                <ArrangingToolbar numSelected={selected.length} />
                            ...
                            {data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map(n => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <TableCell numeric>{n.courseTime}</TableCell>
                                        <TableCell>{n.campus}</TableCell>
...
export default withStyles(styles)(Arranging);